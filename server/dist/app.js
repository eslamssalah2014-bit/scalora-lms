...
app.use('/api/community/chat', chat_routes_js_1.default);
app.use('/community/chat', chat_routes_js_1.default);
...
app.use('/trainers', trainer_routes_js_1.default);
app.use('/api/messages', message_routes_js_1.default);
app.use('/messages', message_routes_js_1.default);
app.use('/api/realtime', realtime_routes_js_1.default);
