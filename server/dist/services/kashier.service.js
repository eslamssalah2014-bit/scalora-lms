...
class KashierPaymentService {
    ...
    resolveMerchantId() {
        ...
        if (rawEnvMid && !midRegex.test(rawEnvMid)) {
            console.warn(`[KASHIER CONFIG WARNING] Environment variable KASHIER_MERCHANT_ID="${rawEnvMid}" does not match required format MID-XXXXX-XXXXX. Overriding with verified Live Merchant ID "MID-50393-317".`);
        }
