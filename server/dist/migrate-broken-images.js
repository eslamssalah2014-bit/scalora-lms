...
async function main() {
    ...
    const localBizImagePath = path_1.default.join(process.cwd(), '..', 'client', 'public', 'courses', 'build-your-business-engine.jpg');
    let bizEngineUrl = '/courses/build-your-business-engine.jpg';
    if (fs_1.default.existsSync(localBizImagePath)) {
        try {
            const buffer = fs_1.default.readFileSync(localBizImagePath);
    ...
    const courseFixes = [
        ...
        },
        {
            ...
            newThumbnail: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1080&auto=format&fit=crop&q=80',
        },
        {
            slug: 'how-to-build-your-lms-by-ai',
            newThumbnail: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1080&auto=format&fit=crop&q=80',
        },
        {
            slug: 'clickup-course',
            newThumbnail: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1080&auto=format&fit=crop&q=80',
        },
    ];
