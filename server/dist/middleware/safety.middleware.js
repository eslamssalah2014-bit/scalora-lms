...
exports.validateProductionSafety = validateProductionSafety;
...
function validateProductionSafety() {
    ...
    console.log(`🔒 Protected Tables (${prisma_js_1.PROTECTED_TABLES.length}): ${prisma_js_1.PROTECTED_TABLES.join(', ')}`);
