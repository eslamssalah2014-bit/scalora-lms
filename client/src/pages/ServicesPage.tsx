...
export const ServicesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-28 pb-24">
      ...
      {/* ========================================================================= */}
      {/* 3. TRUSTED BY AMBITIOUS BUSINESSES */}
      {/* ========================================================================= */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-sm text-slate-400">
            Hear how enterprise operators and founders scaled output without expanding headcount.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6 rounded-2xl space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-300 italic leading-relaxed">
                "Scalora rebuilt our client onboarding and delivery pipeline inside ClickUp and Make. Our team went from handling 15 concurrent clients with chaos to 50+ clients seamlessly."
              </p>
            </div>
            <div className="flex items-center gap-3 pt-4 border-t border-scalora-blue/15">
              ...
              <div>
                ...
                <div className="text-xs text-scalora-blue">COO, Apex Digital Agency</div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-300 italic leading-relaxed">
                "The ERP and inventory synchronization Scalora designed connected our Shopify store, warehouse Airtable, and 3PL logistics with zero dropped orders."
              </p>
            </div>
            <div className="flex items-center gap-3 pt-4 border-t border-scalora-blue/15">
              <img
              ...
              <div>
                ...
                <div className="text-xs text-scalora-blue">Head of Operations, Veloce Goods</div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <p className="text-sm text-slate-300 italic leading-relaxed">
                "The SOP library, automated KPI dashboards, and AI ticket routing designed by Scalora allowed our healthcare network to expand to 4 new clinics in record time."
              </p>
            </div>
            <div className="flex items-center gap-3 pt-4 border-t border-scalora-blue/15">
              <img
              ...
              />
              <div>
                <div className="text-sm font-bold text-white">Dr. Hisham Tarek</div>
                <div className="text-xs text-scalora-blue">Managing Director, Lumina Clinics</div>
              </div>
            </div>
          </div>
        </div>
